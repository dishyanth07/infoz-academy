...
export default function Layout({ children, user, onLogout }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              animate={{ x: 0 }}
              exit={{ x: -300 }}
              className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 shadow-xl lg:hidden"
            >
              <SidebarContent />
            </motion.aside>
          </>
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex sticky top-0 h-screen w-64 bg-white border-r border-gray-200 flex-col shrink-0">
        <SidebarContent />
      </aside>
